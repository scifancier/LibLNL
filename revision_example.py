...
# @Author       : Songhua Wu
# @Time         : Aug 09, 2023
# @File         : revision_example.py
# @Description  : Example to run T-revision with LibLNL
...
def main():
    ...
    if args.net == 'resnet34':
        model = revision_resnet.ResNet34(args.num_class)
        est_model = revision_resnet.ResNet34(args.num_class)
    ...
    epoch_revision = 20
    revision_learning(epoch_revision, args.epochs, model, train_loader, val_loader, test_loader, transition_matrix, optimizer, scheduler)
